...
[![Status](https://img.shields.io/badge/Status-Early%20Prototype-orange?style=for-the-badge)](https://github.com/Frizr/DOWN)

A dark fantasy action RPG prototype built using **Godot Engine 4.6 (.NET/C#)**. The player is dropped into an undead arena and must fight off enemies in a focused combat prototype designed to validate the core gameplay loop.
